...
<div class="row">
	<div class="col-lg-6">
		<h3>Available Balance: <font color='green'><?php echo round($bal1,3); ?></font> <?php echo $currentWallet; ?></h3>
	...
	<div class="col-lg-3">
		<?php if ( isset($_POST['show']) && ($_POST['show'] =="show") )    {
		...
		<center>
			<form name="sql-data" method="post" action="<?php $_SERVER['PHP_SELF']?>">
				<button class='btn btn-default' type="submit" name="show" value="hide">Hide private key</button>
			</form>
		</center>
		<?php
		}
...
<div class="row">
	...
	<p>The network is currently on block <b><?php print_r($coin->getblockcount()); ?></b>.
	...
	<?php 
		...
		echo "<p>Staking Status:<b>" . $nf["staking status"] . "</b></p>";
		echo "<p>Wallet Version:<b>" . $nf["walletversion"] . "</b></p>";


	?>	
	</div>
     <?php if(file_exists($dataDir . $currentWallet."notes.php")){
       include($dataDir . $currentWallet.'notes.php');
